...
private:
    ...
    void onPrepareDraws(Target* target) override {
        ...
        void* verts = target->makeVertexSpace(vertexStride, instanceCount*vertexCount,
...
DRAW_BATCH_TEST_DEFINE(NonAAStrokeRectBatch) {
    ...
    return GrNonAAStrokeRectBatch::Create(color, viewMatrix, rect,
                                          strokeWidth, random->nextBool(), NULL);
}
